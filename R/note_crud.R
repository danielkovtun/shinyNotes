...
#' @param category_options Category column row value options. Useful if table is empty. Default is \code{NA} (retrieved from data)
#' @param table_id Named list with member 'table' and 'schema' referring to a database table containing notes.
#' @param db_conn An object that inherits from \code{\link[=DBI]{DBIConnection-class}},
#'   typically generated by \code{\link[=DBI]{dbConnect()}}
#' @param style_options Optional named list of \code{CSS} styles to apply to note panel elements.
#'
#' @examples
#' if(interactive()){
#'   shiny::callModule(
